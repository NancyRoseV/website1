...
(function ($) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var scrollReveal = document.getElementById("scroll-reveal");
        var sectionText = scrollReveal.querySelector(".section-text");
    
        window.addEventListener("scroll", function () {
            var revealPosition = scrollReveal.getBoundingClientRect().top;
    
            if (revealPosition < window.innerHeight / 2) {
                sectionText.classList.add("reveal");
            } else {
                sectionText.classList.remove("reveal");
            }
        });
    });
